...
export type PatientQuery = { __typename?: 'query_root', patients_by_pk?: { __typename?: 'patients', name: string, phone: string, pesel: string, surname: string, user: { __typename?: 'users', email?: any | null } } | null };

export type PatientsQueryVariables = Exact<{ [key: string]: never; }>;


export type PatientsQuery = { __typename?: 'query_root', patients: Array<{ __typename?: 'patients', id: any, name: string, pesel: string, phone: string, surname: string }> };
...
/**
 * __useOpinionsQuery__
 *
 * To run a query within a React component, call `useOpinionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useOpinionsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useOpinionsQuery({
 *   variables: {
 *      physiotherapist_id: // value for 'physiotherapist_id'
 *   },
 * });
 */
export function useOpinionsQuery(baseOptions?: Apollo.QueryHookOptions<OpinionsQuery, OpinionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<OpinionsQuery, OpinionsQueryVariables>(OpinionsDocument, options);
      }
export function useOpinionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<OpinionsQuery, OpinionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<OpinionsQuery, OpinionsQueryVariables>(OpinionsDocument, options);
        }
export type OpinionsQueryHookResult = ReturnType<typeof useOpinionsQuery>;
export type OpinionsLazyQueryHookResult = ReturnType<typeof useOpinionsLazyQuery>;
export type OpinionsQueryResult = Apollo.QueryResult<OpinionsQuery, OpinionsQueryVariables>;
export function refetchOpinionsQuery(variables?: OpinionsQueryVariables) {
      return { query: OpinionsDocument, variables: variables }
    }
...
export function refetchPatientQuery(variables?: PatientQueryVariables) {
      return { query: PatientDocument, variables: variables }
    }
...
export function refetchPatientsQuery(variables?: PatientsQueryVariables) {
      return { query: PatientsDocument, variables: variables }
    }
export const PhysiotherapistsDocument = gql`
    query Physiotherapists {
  physiotherapists {
    id
    aboutMe
    adress
...
/**
 * __usePhysiotherapistsQuery__
 *
 * To run a query within a React component, call `usePhysiotherapistsQuery` and pass it any options that fit your needs.
 * When your component renders, `usePhysiotherapistsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePhysiotherapistsQuery({
 *   variables: {
 *   },
 * });
 */
export function usePhysiotherapistsQuery(baseOptions?: Apollo.QueryHookOptions<PhysiotherapistsQuery, PhysiotherapistsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PhysiotherapistsQuery, PhysiotherapistsQueryVariables>(PhysiotherapistsDocument, options);
      }
export function usePhysiotherapistsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PhysiotherapistsQuery, PhysiotherapistsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PhysiotherapistsQuery, PhysiotherapistsQueryVariables>(PhysiotherapistsDocument, options);
        }
export type PhysiotherapistsQueryHookResult = ReturnType<typeof usePhysiotherapistsQuery>;
export type PhysiotherapistsLazyQueryHookResult = ReturnType<typeof usePhysiotherapistsLazyQuery>;
export type PhysiotherapistsQueryResult = Apollo.QueryResult<PhysiotherapistsQuery, PhysiotherapistsQueryVariables>;
export function refetchPhysiotherapistsQuery(variables?: PhysiotherapistsQueryVariables) {
      return { query: PhysiotherapistsDocument, variables: variables }
    }