...
export type CreateOpinionMutation = {
  __typename?: "mutation_root";
  insert_opinions_one?: { __typename?: "opinions"; id: any } | null;
};
...
export type PatientQuery = {
  ...
  patients_by_pk?: {
    ...
    pesel: string;
    surname: string;
    user: { __typename?: "users"; email?: any | null };
  } | null;
};
...
export type PhysiotherapistsQuery = {
  __typename?: "query_root";
...
`;
export type CreateOpinionMutationFn = Apollo.MutationFunction<
...
export function useCreateOpinionMutation(
  ...
  return Apollo.useMutation<
    CreateOpinionMutation,
    CreateOpinionMutationVariables
  >(CreateOpinionDocument, options);
}
export type CreateOpinionMutationHookResult = ReturnType<
  typeof useCreateOpinionMutation
>;
export type CreateOpinionMutationResult =
  Apollo.MutationResult<CreateOpinionMutation>;
export type CreateOpinionMutationOptions = Apollo.BaseMutationOptions<
  CreateOpinionMutation,
  CreateOpinionMutationVariables
>;
...
export function useOpinionsQuery(
  baseOptions?: Apollo.QueryHookOptions<OpinionsQuery, OpinionsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<OpinionsQuery, OpinionsQueryVariables>(
    OpinionsDocument,
    options
  );
}
export function useOpinionsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    OpinionsQuery,
    OpinionsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<OpinionsQuery, OpinionsQueryVariables>(
    OpinionsDocument,
    options
  );
}
export type OpinionsQueryHookResult = ReturnType<typeof useOpinionsQuery>;
export type OpinionsLazyQueryHookResult = ReturnType<
  typeof useOpinionsLazyQuery
>;
export type OpinionsQueryResult = Apollo.QueryResult<
  OpinionsQuery,
  OpinionsQueryVariables
>;
 ...
 * });
 */
export function usePhysiotherapistsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    PhysiotherapistsQuery,
    PhysiotherapistsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PhysiotherapistsQuery, PhysiotherapistsQueryVariables>(
    PhysiotherapistsDocument,
    options
  );
}
export function usePhysiotherapistsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    PhysiotherapistsQuery,
    PhysiotherapistsQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    PhysiotherapistsQuery,
    PhysiotherapistsQueryVariables
  >(PhysiotherapistsDocument, options);
}
export type PhysiotherapistsQueryHookResult = ReturnType<
  typeof usePhysiotherapistsQuery
>;
export type PhysiotherapistsLazyQueryHookResult = ReturnType<
  typeof usePhysiotherapistsLazyQuery
>;
export type PhysiotherapistsQueryResult = Apollo.QueryResult<
  PhysiotherapistsQuery,
  PhysiotherapistsQueryVariables
>;
export function refetchPhysiotherapistsQuery(
  variables?: PhysiotherapistsQueryVariables
) {
