...
export type CancelVisitMutation = { __typename?: 'mutation_root', delete_visits_by_pk?: { __typename?: 'visits', id: any } | null };
...
export type CreateVisitMutation = { __typename?: 'mutation_root', insert_visits_one?: { __typename?: 'visits', id: any } | null };

export type PatientVisitsQueryVariables = Exact<{
  id?: InputMaybe<Scalars['uuid']>;
}>;
...
export type PhysiotherapistVisitsQuery = { __typename?: 'query_root', visits: Array<{ __typename?: 'visits', id: any, end_timestamp: any, start_timestamp: any, patient?: { __typename?: 'patients', name: string, surname: string } | null, visit_type?: { __typename?: 'visit_types', name: string, price: string } | null }> };

export type VisitsByStartDateQueryVariables = Exact<{
  startDate?: InputMaybe<Scalars['timestamptz']>;
  physioId?: InputMaybe<Scalars['uuid']>;
}>;


export type VisitsByStartDateQuery = { __typename?: 'query_root', visits: Array<{ __typename?: 'visits', id: any }> };


export const CancelVisitDocument = gql`
    mutation CancelVisit($id: uuid = "") {
...
export type CancelVisitMutationResult = Apollo.MutationResult<CancelVisitMutation>;
...
export const CreateVisitDocument = gql`
    mutation CreateVisit($start_timestamp: timestamptz = "", $end_timestamp: timestamptz = "", $patient_id: uuid = "", $physiotherapist_id: uuid = "", $visit_type_id: uuid = "") {
  insert_visits_one(
    object: {start_timestamp: $start_timestamp, end_timestamp: $end_timestamp, patient_id: $patient_id, physiotherapist_id: $physiotherapist_id, visit_type_id: $visit_type_id}
  ) {
    id
  }
}
 ...
 *      end_timestamp: // value for 'end_timestamp'
 ...
 * });
 */
export function usePatientVisitsQuery(baseOptions?: Apollo.QueryHookOptions<PatientVisitsQuery, PatientVisitsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PatientVisitsQuery, PatientVisitsQueryVariables>(PatientVisitsDocument, options);
      }
export function usePatientVisitsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PatientVisitsQuery, PatientVisitsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PatientVisitsQuery, PatientVisitsQueryVariables>(PatientVisitsDocument, options);
        }
export type PatientVisitsQueryHookResult = ReturnType<typeof usePatientVisitsQuery>;
export type PatientVisitsLazyQueryHookResult = ReturnType<typeof usePatientVisitsLazyQuery>;
export type PatientVisitsQueryResult = Apollo.QueryResult<PatientVisitsQuery, PatientVisitsQueryVariables>;
export function refetchPatientVisitsQuery(variables?: PatientVisitsQueryVariables) {
      return { query: PatientVisitsDocument, variables: variables }
    }
export const PhysiotherapistVisitsDocument = gql`
...
/**
 * __usePhysiotherapistVisitsQuery__
 *
 * To run a query within a React component, call `usePhysiotherapistVisitsQuery` and pass it any options that fit your needs.
 * When your component renders, `usePhysiotherapistVisitsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = usePhysiotherapistVisitsQuery({
 *   variables: {
 *      physioId: // value for 'physioId'
 *   },
 * });
 */
export function usePhysiotherapistVisitsQuery(baseOptions?: Apollo.QueryHookOptions<PhysiotherapistVisitsQuery, PhysiotherapistVisitsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<PhysiotherapistVisitsQuery, PhysiotherapistVisitsQueryVariables>(PhysiotherapistVisitsDocument, options);
      }
export function usePhysiotherapistVisitsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PhysiotherapistVisitsQuery, PhysiotherapistVisitsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<PhysiotherapistVisitsQuery, PhysiotherapistVisitsQueryVariables>(PhysiotherapistVisitsDocument, options);
        }
export type PhysiotherapistVisitsQueryHookResult = ReturnType<typeof usePhysiotherapistVisitsQuery>;
export type PhysiotherapistVisitsLazyQueryHookResult = ReturnType<typeof usePhysiotherapistVisitsLazyQuery>;
export type PhysiotherapistVisitsQueryResult = Apollo.QueryResult<PhysiotherapistVisitsQuery, PhysiotherapistVisitsQueryVariables>;
export function refetchPhysiotherapistVisitsQuery(variables?: PhysiotherapistVisitsQueryVariables) {
      return { query: PhysiotherapistVisitsDocument, variables: variables }
    }
export const VisitsByStartDateDocument = gql`
    query VisitsByStartDate($startDate: timestamptz = "", $physioId: uuid = "") {
  visits(
    where: {start_timestamp: {_eq: $startDate}, physiotherapist_id: {_eq: $physioId}}
  ) {
    id
  }
}
...
/**
 * __useVisitsByStartDateQuery__
 *
 * To run a query within a React component, call `useVisitsByStartDateQuery` and pass it any options that fit your needs.
 * When your component renders, `useVisitsByStartDateQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useVisitsByStartDateQuery({
 *   variables: {
 ...
 * });
 */
export function useVisitsByStartDateQuery(baseOptions?: Apollo.QueryHookOptions<VisitsByStartDateQuery, VisitsByStartDateQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<VisitsByStartDateQuery, VisitsByStartDateQueryVariables>(VisitsByStartDateDocument, options);
      }
export function useVisitsByStartDateLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<VisitsByStartDateQuery, VisitsByStartDateQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<VisitsByStartDateQuery, VisitsByStartDateQueryVariables>(VisitsByStartDateDocument, options);
        }
export type VisitsByStartDateQueryHookResult = ReturnType<typeof useVisitsByStartDateQuery>;
export type VisitsByStartDateLazyQueryHookResult = ReturnType<typeof useVisitsByStartDateLazyQuery>;
export type VisitsByStartDateQueryResult = Apollo.QueryResult<VisitsByStartDateQuery, VisitsByStartDateQueryVariables>;
export function refetchVisitsByStartDateQuery(variables?: VisitsByStartDateQueryVariables) {
      return { query: VisitsByStartDateDocument, variables: variables }
    }