...
export type DeleteVisitTypeMutationVariables = Exact<{
  id?: InputMaybe<Scalars['uuid']>;
}>;


export type DeleteVisitTypeMutation = { __typename?: 'mutation_root', delete_visit_types_by_pk?: { __typename?: 'visit_types', id: any } | null };
...
export type PatientByUserIdQuery = { __typename?: 'query_root', patients: Array<{ __typename?: 'patients', id: any, name: string, pesel: string, surname: string, phone: string, user: { __typename?: 'users', email?: any | null } }> };


export const DeleteVisitTypeDocument = gql`
    mutation DeleteVisitType($id: uuid = "") {
  delete_visit_types_by_pk(id: $id) {
    id
  }
}
    `;
export type DeleteVisitTypeMutationFn = Apollo.MutationFunction<DeleteVisitTypeMutation, DeleteVisitTypeMutationVariables>;

/**
 * __useDeleteVisitTypeMutation__
 *
 * To run a mutation, you first call `useDeleteVisitTypeMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useDeleteVisitTypeMutation` returns a tuple that includes:
 ...
 *
 * @example
 * const [deleteVisitTypeMutation, { data, loading, error }] = useDeleteVisitTypeMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useDeleteVisitTypeMutation(baseOptions?: Apollo.MutationHookOptions<DeleteVisitTypeMutation, DeleteVisitTypeMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<DeleteVisitTypeMutation, DeleteVisitTypeMutationVariables>(DeleteVisitTypeDocument, options);
      }
export type DeleteVisitTypeMutationHookResult = ReturnType<typeof useDeleteVisitTypeMutation>;
export type DeleteVisitTypeMutationResult = Apollo.MutationResult<DeleteVisitTypeMutation>;
export type DeleteVisitTypeMutationOptions = Apollo.BaseMutationOptions<DeleteVisitTypeMutation, DeleteVisitTypeMutationVariables>;
