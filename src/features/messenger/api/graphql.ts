...
export type CreateMessageMutation = {
  __typename?: "mutation_root";
  insert_messages_one?: { __typename?: "messages"; id: any } | null;
};
...
export type PatientContactsQuery = {
  __typename?: "query_root";
...
export type PhysiotherapistContactsQuery = {
  __typename?: "query_root";
  patients: Array<{
    __typename?: "patients";
    id: any;
...
export const PatientContactsDocument = gql`
  query PatientContacts($patient_id: uuid = "") {
    physiotherapists(
      where: { messages: { patient_id: { _eq: $patient_id } } }
    ) {
      name
      surname
      id
 ...
 * });
 */
export function usePatientContactsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    PatientContactsQuery,
    PatientContactsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PatientContactsQuery, PatientContactsQueryVariables>(
    PatientContactsDocument,
    options
  );
}
export function usePatientContactsLazyQuery(
  ...
  return Apollo.useLazyQuery<
    PatientContactsQuery,
    PatientContactsQueryVariables
  >(PatientContactsDocument, options);
}
export type PatientContactsQueryHookResult = ReturnType<
  typeof usePatientContactsQuery
>;
export type PatientContactsLazyQueryHookResult = ReturnType<
  typeof usePatientContactsLazyQuery
>;
export type PatientContactsQueryResult = Apollo.QueryResult<
  PatientContactsQuery,
  PatientContactsQueryVariables
>;
export function refetchPatientContactsQuery(
  variables?: PatientContactsQueryVariables
) {
 ...
 * });
 */
export function usePhysiotherapistContactsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    PhysiotherapistContactsQuery,
    PhysiotherapistContactsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    PhysiotherapistContactsQuery,
    PhysiotherapistContactsQueryVariables
  >(PhysiotherapistContactsDocument, options);
}
export function usePhysiotherapistContactsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    PhysiotherapistContactsQuery,
    PhysiotherapistContactsQueryVariables
  >
...
export type PhysiotherapistContactsQueryHookResult = ReturnType<
  typeof usePhysiotherapistContactsQuery
>;
export type PhysiotherapistContactsLazyQueryHookResult = ReturnType<
  typeof usePhysiotherapistContactsLazyQuery
>;
export type PhysiotherapistContactsQueryResult = Apollo.QueryResult<
  PhysiotherapistContactsQuery,
  PhysiotherapistContactsQueryVariables
>;
export function refetchPhysiotherapistContactsQuery(
  variables?: PhysiotherapistContactsQueryVariables
) {
...
export function useUserMessagesQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<UserMessagesQuery, UserMessagesQueryVariables>(
...
export function useUserMessagesLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<UserMessagesQuery, UserMessagesQueryVariables>(
    UserMessagesDocument,
    options
  );
}
export type UserMessagesQueryHookResult = ReturnType<
  typeof useUserMessagesQuery
>;
export type UserMessagesLazyQueryHookResult = ReturnType<
  typeof useUserMessagesLazyQuery
>;
export type UserMessagesQueryResult = Apollo.QueryResult<
  UserMessagesQuery,
  UserMessagesQueryVariables
>;
export function refetchUserMessagesQuery(
  variables?: UserMessagesQueryVariables
) {
