...
export type UpdateDisplayMessageMutationVariables = Exact<{
  id?: InputMaybe<Scalars['uuid']>;
}>;


export type UpdateDisplayMessageMutation = { __typename?: 'mutation_root', update_messages_by_pk?: { __typename?: 'messages', id: any } | null };

export type NotDisplayedMessagesQueryVariables = Exact<{
  patient_id?: InputMaybe<Scalars['uuid']>;
  physiotherapist_id?: InputMaybe<Scalars['uuid']>;
  not_created_by?: InputMaybe<Scalars['uuid']>;
}>;


export type NotDisplayedMessagesQuery = { __typename?: 'query_root', messages: Array<{ __typename?: 'messages', id: any }> };
...
export type UserMessagesQuery = { __typename?: 'query_root', messages: Array<{ __typename?: 'messages', id: any, created_at: any, message: string, patient_id?: any | null, physiotherapist_id?: any | null, created_by?: any | null, displayed: boolean }> };
...
export const UpdateDisplayMessageDocument = gql`
  ...
  update_messages_by_pk(pk_columns: {id: $id}, _set: {displayed: true}) {
    ...
    `;
export type UpdateDisplayMessageMutationFn = Apollo.MutationFunction<UpdateDisplayMessageMutation, UpdateDisplayMessageMutationVariables>;

/**
 * __useUpdateDisplayMessageMutation__
 *
 * To run a mutation, you first call `useUpdateDisplayMessageMutation` within a React component and pass it any options that fit your needs.
 * When your component renders, `useUpdateDisplayMessageMutation` returns a tuple that includes:
 * - A mutate function that you can call at any time to execute the mutation
 * - An object with fields that represent the current status of the mutation's execution
 *
 * @param baseOptions options that will be passed into the mutation, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options-2;
 *
 * @example
 * const [updateDisplayMessageMutation, { data, loading, error }] = useUpdateDisplayMessageMutation({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useUpdateDisplayMessageMutation(baseOptions?: Apollo.MutationHookOptions<UpdateDisplayMessageMutation, UpdateDisplayMessageMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<UpdateDisplayMessageMutation, UpdateDisplayMessageMutationVariables>(UpdateDisplayMessageDocument, options);
      }
export type UpdateDisplayMessageMutationHookResult = ReturnType<typeof useUpdateDisplayMessageMutation>;
export type UpdateDisplayMessageMutationResult = Apollo.MutationResult<UpdateDisplayMessageMutation>;
export type UpdateDisplayMessageMutationOptions = Apollo.BaseMutationOptions<UpdateDisplayMessageMutation, UpdateDisplayMessageMutationVariables>;
export const NotDisplayedMessagesDocument = gql`
    query NotDisplayedMessages($patient_id: uuid = "", $physiotherapist_id: uuid = "", $not_created_by: uuid = "") {
  messages(
    where: {patient_id: {_eq: $patient_id}, displayed: {_eq: false}, physiotherapist_id: {_eq: $physiotherapist_id}, created_by: {_neq: $not_created_by}}
  ) {
    id
  }
}
...
/**
 * __useNotDisplayedMessagesQuery__
 *
 * To run a query within a React component, call `useNotDisplayedMessagesQuery` and pass it any options that fit your needs.
 * When your component renders, `useNotDisplayedMessagesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useNotDisplayedMessagesQuery({
 *   variables: {
 *      patient_id: // value for 'patient_id'
 *      physiotherapist_id: // value for 'physiotherapist_id'
 *      not_created_by: // value for 'not_created_by'
 *   },
 * });
 */
export function useNotDisplayedMessagesQuery(baseOptions?: Apollo.QueryHookOptions<NotDisplayedMessagesQuery, NotDisplayedMessagesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<NotDisplayedMessagesQuery, NotDisplayedMessagesQueryVariables>(NotDisplayedMessagesDocument, options);
      }
export function useNotDisplayedMessagesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<NotDisplayedMessagesQuery, NotDisplayedMessagesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<NotDisplayedMessagesQuery, NotDisplayedMessagesQueryVariables>(NotDisplayedMessagesDocument, options);
        }
export type NotDisplayedMessagesQueryHookResult = ReturnType<typeof useNotDisplayedMessagesQuery>;
export type NotDisplayedMessagesLazyQueryHookResult = ReturnType<typeof useNotDisplayedMessagesLazyQuery>;
export type NotDisplayedMessagesQueryResult = Apollo.QueryResult<NotDisplayedMessagesQuery, NotDisplayedMessagesQueryVariables>;
export function refetchNotDisplayedMessagesQuery(variables?: NotDisplayedMessagesQueryVariables) {
      return { query: NotDisplayedMessagesDocument, variables: variables }
    }
